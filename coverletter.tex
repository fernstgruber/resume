...
\cvitem{2016--2017} {Educational Leave (Bildungskarenz) devoted to work on PhD thesis with the working title 'Digital terrain analysis to support field soil survey' }
...
\cvitem{2016--2017} {Educational Leave (Bildungskarenz) }
\section{Languages}
